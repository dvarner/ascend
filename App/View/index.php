    ...
    <div class="col-md-9 text-left">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><code><?=Ascend\Core\file2code_example(PATH_COMMANDLINE . 'ExampleCommandLine.php'); ?></code></p>
        ...
        <div class="card">
            <div class="card-header">
                <a class="doc-header" name="model">Setup Model</a>
            </div>
            <div class="card-body">
                ...
                <p><code><?=Ascend\Core\file2code_example(PATH_MODELS . 'Example.php'); ?></code></p>
