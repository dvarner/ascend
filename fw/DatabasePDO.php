...
class DatabasePDO {
    ...
    public $storeConnectionName = 'local';
    public $dbh = null;
    ...
    public function __construct() {
        if (BS::getConfig('db')) {
            ...
            $this->setConnection('local'); // Select "local" as default connection. Not exist gets first one.
        } else {
            die('Failed to find database connections in config!');
        }
    }
