    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                ...
                <p>Ascend eventually wants to make conversions for moving to and from frameworks as easy as
                    possible.</p>
            ...
            <div class="row">
                ...
                <p><a href="https://packagist.org/packages/dvarner/ascendphp">https://packagist.org/packages/dvarner/ascendphp</a>
                </p>
            ...
            <div class="row">
                ...
                <ul>
                    ...
                    <li>fw/feature - Files to run additional features for framework like user permissions, sessions,
                        etc
                    </li>
                ...
                <ul>
                    ...
                    <li>app/config.php - Configurations created from app/config.sample.php</li>
                </ul>
